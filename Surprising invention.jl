...
# ╔═╡ f1b5edc0-d349-11ef-2202-e16c2431f21e
begin
	using Distributions
	using Combinatorics
	using CSV
...
# ╔═╡ 2b722f4b-0a5b-456a-a42e-85addfc94d51
Plots.theme(:dark)

# ╔═╡ b11a7201-6859-482d-bbf3-995d0bf5f238
@__DIR__

# ╔═╡ b0c786b1-75e8-422f-ab35-d1e029ecb036


# ╔═╡ d6deba2d-f492-4b6a-b9cb-f8f2e7040066
d = Normal()

# ╔═╡ 6c5029e1-bf16-4e35-aa61-7eb19a24e063
x = rand(d, 100)

# ╔═╡ d0e42b29-2f70-4f36-8ce1-fad0b1db7adb
struct Card
	name::String
	ink::Int8
	str::Int8
...
# ╔═╡ 9cb568d8-7c89-4e53-898a-6faa10c1dcba
struct Deck
	cards # list of card objects
	function Deck(::Vector{Any})
		println("?")
	end
	function Count()
		println("...")
...
# ╔═╡ e8d0a6d0-817d-4dd1-9f30-9a89b8ffc59b
path::String = "C:\\Users\\Eric\\Documents\\lorcana"

# ╔═╡ 24a96ab0-4659-4d95-b5e4-2d3f468b64b7
cards_path = path * "\\cards.json"

# ╔═╡ 26aa2a99-fcb6-40d3-9892-e614c90c7f7b
decklist_path = path * "\\decklist_nac.txt"

# ╔═╡ 73ab6f38-30d9-4f80-93f4-3bf370e63c7d
cards_json = JSON.parsefile(cards_path)

# ╔═╡ c6dea451-2f9f-4906-970b-e8c567a26807
open(decklist_path)

# ╔═╡ fdae6a72-3b1c-4900-958d-17e21989c1f0
...
# ╔═╡ 8cf39658-f4fa-48fe-a67b-4c282e5c3611
deck_requirements::Vector{String} = readlines(open(decklist_path), keep = false)

# ╔═╡ 9b1f8ead-9949-495e-9d8f-ca1ed31b687a
length(cards_json)

# ╔═╡ e4198c6b-8ef0-41a8-a835-f230c36eaacc
cards_json[1]


# ╔═╡ 1ebde82f-45e5-4fe2-9501-55f4bb23e01d
begin
...
# ╔═╡ 4c551dd9-49b3-4238-a962-e9486043fb59
deck_json

# ╔═╡ d82138c6-964d-44e6-908a-6fae891eec6f
# sort(collect(deck_json), by=x->x["Cost"]+x["Card_Num"]/100)

# ╔═╡ 0e4bc18a-f812-4d21-97de-5a1a37725a80


# ╔═╡ 41102c9c-ff3a-415e-a24d-b100365b635f
deck_dataframe = DataFrame(Tables.dictcolumntable(deck_json))

# ╔═╡ 6f34246b-4eed-4ebd-89f6-f2ef96d80a43
begin
...
# ╔═╡ ae4e75a5-7926-491d-95d7-3c99d146df61
name_to_image

# ╔═╡ 245b8ce6-c72e-43b0-b48d-fbc6afd8030c
begin
...
# ╔═╡ 4604eae8-0e2b-4c71-a973-cedddcd69bec
colors = get_color_palette(:auto, plot_color(:white));

# ╔═╡ c0062bc6-f484-4550-9d85-4e17749a1bcc
begin
...
# ╔═╡ 07e957ff-f38c-4d2e-b30e-d5a0e0a799cb
begin
...
# ╔═╡ ec2dd0ae-0f77-4390-b165-77ce79a10ea1
binomial(60,7)

# ╔═╡ c9109ea2-91d0-4f69-bc30-ebd2a64618fb
begin
	Plots.theme(:dark)
...
# ╔═╡ aabbb87d-fa1d-415a-abf0-1f5b03f2112c
n_cards_till_max_cost

# ╔═╡ c260b695-8e1e-4507-99c2-c3f383ac846b
begin
	n_samples = 10000
	expectedValue = 0
	for i in range(1,length=n_samples)
		expectedValue += (sum(shuffle(deck_dataframe[!,"Inkable"])[1:7])/7)
	end
	expectedValue/n_samples
end

# ╔═╡ 1d341899-45e9-4fd4-a11e-10172980f8fc
# groupedbar(rand(10,3), bar_position = :stack, bar_width=0.7)

# ╔═╡ fd2ec45a-2e17-49f3-9524-b07c6051368f
# groupedbar(deck_dataframe, bar_position = :stack, bar_width=0.7)
