...
# ╔═╡ 489d2740-9770-4ad9-be71-8b2525ef1e41
begin
	using Distributions
	using Combinatorics
	using CSV
...
begin
    ...
    # repeat deck in Vector
    #LibraryC.deck_json
    player_decks = [LibraryC.deck_json, LibraryC.deck_json]
    game = GameScriptJL.create_game_from_cards(player_decks, player_names)

    println("Game created successfully with players: ", 
...
begin
	...
	fourteen = deck_dataframe[shuffle(1:nrow(deck_dataframe))[1:14], :]
